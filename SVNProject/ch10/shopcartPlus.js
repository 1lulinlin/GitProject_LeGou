...
$(function(){
    ...
    var $tbodyInput = $('tbody input[type=checkbox');  // 表格中的每一个行的选择框
    var $totalPriceInput = $('.totalPrice input[type=checkbox'); //  计算总价中的全选框
   /* 全选 */
   /*
       1.给表头中的全选按钮 绑定点击事件 点击的时候 获取到它的选中状态(true / fales)
   ...
   */
    ...
    */
    $totalPriceInput.change(function(){
        ...
        $tbodyInput.prop('checked',checkState);  //赋值给表格中的全选框
        allTotal(); //总计
    })
